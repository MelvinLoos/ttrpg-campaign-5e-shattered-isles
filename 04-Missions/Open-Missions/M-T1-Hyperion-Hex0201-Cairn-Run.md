...
## Objectives
1. **Primary — Recover the Cache:** Travel to [[../../03-Hex-Map/Region-01-Safe-Zone/Hex-0201|Hex 0201: Gullcry Strand]], locate **the Cairn Above the Tide** in the sea-grass, and recover **both crates of raw Blight-crystals** intact. Deliver them to Lady Vexis's factor at the **Gilded Seat** before sundown of the day they are recovered. *(Hazard reminder: any violent impact on a crate triggers a DC 12 Dex save vs. 1d4 necrotic damage to everyone within 5 ft. Carry, do not roll.)*
