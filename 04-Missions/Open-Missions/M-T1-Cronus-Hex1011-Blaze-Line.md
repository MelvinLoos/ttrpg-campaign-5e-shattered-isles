...
status: open
canon_status: draft
giving_faction: Cronus Dominion
target_hex: Hex-1011
...
# Mission: Hold the Blaze Line

**Client:** [[../../01-Campaign-Bible/Entities/NPCs/Commander-Valerius|Commander Valerius]] representing [[../../02-Factions-and-Bastions/Cronus-Dominion|Cronus Dominion]]
**Target Location:** [[../../03-Hex-Map/Region-01-Safe-Zone/Hex-1011|Hex-1011]]

---

## The Hook
Posted on the muster board outside the Iron Seat barracks in Havenport, in a clean engineer's hand and signed with Commander Valerius's seal:

> *"Surveyors of the North Road have placed marker-nails along the planned right-of-way through Brineglass Wood. A ribbon has been cut. The crew has not yet been molested, but the Dominion does not pay engineers to flinch. Walk the line from the North Gate to the deepest blaze. Identify who is interfering. If they are still in the wood, secure them — alive — for questioning. The Dominion pays for results, not theatrics."*
>
...
## Objectives
* **Primary Objective:** *Walk the Line.* Travel the **Old Haven Road** north into Brineglass Wood, follow the **Dominion Blazes** (the rayed-sun stamped iron nails) along their full surveyed length, identify the cut **red surveyor's ribbon**, and bring back a written report — name, sign, or eyewitness — of who is interfering with the line. This advances the Cronus Dominion's *Construct the "Iron Line" Outpost Chain* clock (Step 2/6). *Bonus: capture the interferer alive.*
* **Denial / Secondary Objective:** *Deny the Concord a Listening Post.* Locate the **Listening Stump** off the blaze-line and either fell its remaining root-system, salt the cut, or bring a sample of its sap-soft heartwood back to the Iron Seat. Valerius's engineers suspect the Stump is being used by *someone* (Atlas Concord scouts) to monitor the road's progress. Denying this asset slows the Atlas Concord's *Awaken the Primordial Guardian (Oakharrow)* clock by one tick.
...
|---|---|---|
| FP (Cronus Dominion) | 1 | 2 |
| BP (Iron Seat, Havenport) | 2 | 3 |
| Gold (per character) | 50 gp | 75 gp |
